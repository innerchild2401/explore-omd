      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-8">
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] lg:items-start">
              ...
              <div className="space-y-2">
                ...
                {business.location?.address && (
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-base">{business.location.address}</span>
                  </div>
                )}
              </div>
              <div className="flex flex-wrap gap-3 text-sm text-gray-700">
                {hotel?.star_rating && (
                  <span className="inline-flex items-center gap-2 rounded-full bg-yellow-50 px-3 py-1 text-yellow-700">
            ...
            {searchParams.checkIn && searchParams.checkOut && (
              <div className="rounded-2xl border border-gray-100 bg-gray-50/60 p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-900">Your Travel Details</h3>
...
export async function generateMetadata({ params }: HotelPageProps) {
  ...
  const mainImage = firstImage && typeof firstImage === 'string' ? getImageUrl(firstImage) : null;
