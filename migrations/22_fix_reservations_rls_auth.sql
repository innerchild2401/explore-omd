-- =============================================
-- Migration 22: Fix reservations RLS with proper authentication
-- =============================================
-- This migration creates RLS policies that handle null auth.uid() gracefully
...
DROP POLICY IF EXISTS "Temporary: Allow all authenticated users to manage reservations" ON reservations;

-- Create robust policies that handle authentication properly
