-- =============================================
-- Migration 34: Prevent double booking and ensure proper inventory management
-- =============================================
...
BEGIN
  ...
  IF OLD.reservation_status != 'cancelled' 
    ...
    -- The room will be available for other reservations
    -- This is handled by the availability check function
    -- which only considers confirmed/checked_in/checked_out reservations
    NULL;
  END IF;
