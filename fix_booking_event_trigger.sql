...
-- This makes the trigger run with the permissions of the user who triggers it
...
RETURNS TRIGGER 
SECURITY DEFINER -- This makes the function run with the permissions of its creator (the database owner)
